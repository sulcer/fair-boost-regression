...
class FairBoostRegressor_v2(AdaBoostRegressor):
    """
    ...
    # v2 - existing FairBoostRegressor fixed
    def _boost(self, iboost, X, y, sample_weight, random_state):
        ...
        # Calculate beta, the error rate of the estimator
        beta = estimator_error / (1.0 - estimator_error)

        # Compute the weight for the estimator based on beta
